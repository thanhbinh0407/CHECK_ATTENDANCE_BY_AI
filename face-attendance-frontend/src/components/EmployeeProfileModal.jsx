...
export default function EmployeeProfileModal({ employee, onClose, onUpdate }) {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      // Sync email and companyEmail
      const formData = {
        ...editForm,
        email: editForm.email || editForm.companyEmail || employeeDetails?.email || employeeDetails?.companyEmail,
        companyEmail: editForm.email || editForm.companyEmail || employeeDetails?.email || employeeDetails?.companyEmail
      };
